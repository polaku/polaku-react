          ...
          this.props.isAdminHR && <Grid style={{ width: '10%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <Grid style={{ minWidth: '100px', display: 'flex', justifyContent: 'space-around', alignItems: 'center', flexWrap: 'wrap' }}>
              ...
              <Tooltip title="Edit karyawan" aria-label="edit-data">
                <img src={require('../../Assets/edit.png').default} loading="lazy" alt="Logo" style={{ width: 23, maxHeight: 23, alignSelf: 'center', cursor: 'pointer' }} onClick={() => this.props.history.push('/setting/setting-perusahaan/add-employee', { data: this.props.data, index: this.props.index })} />
              </Tooltip>
            </Grid>
          </Grid>
        }
