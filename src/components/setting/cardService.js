        ...
        <Grid style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <Grid style={{ minWidth: '100px', display: 'flex', justifyContent: 'space-around', alignItems: 'center', flexWrap: 'wrap' }}>
            ...
            <Tooltip title="Edit dinas karyawan" aria-label="edit-data">
              <img src={require('../../Assets/edit.png').default} alt="Logo" style={{ width: 23, maxHeight: 23, alignSelf: 'center', cursor: 'pointer' }} onClick={() => this.props.history.push('/setting/setting-perusahaan/add-service', { user_id: this.props.data.userId, index: this.props.index })} />
            </Tooltip>
